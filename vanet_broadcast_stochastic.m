...
for i=1:num_slots
    ...
    % only vehicle 1 transmitting 
 
    
    % if last transmission has been acked
    ...
    for j=2:num_vehicles
        ...
        if vehicle1_Tx_time(next_Tx_idx) == i*slot_time
            ...
            if (d<=R) && (SNR >= SNR_thresh)
                ...
                % calculate CW_max and random broadcast time
